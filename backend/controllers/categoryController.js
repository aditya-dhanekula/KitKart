...
const getCategories = async (req, res, next) => {
    ...
    try {
        ...
        // Way to fetch all of the categories from the database
        // Inside the curly braces we can write arguments to fetch specific data that is needed e.g. fetch only computer category
        res.json(categories)
    } catch(error) {
        next(error)
    }
