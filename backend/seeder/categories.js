const categories = [
  ...
  },
  {
    name: "Fashion",
    description:
      "Explore a diverse selection of clothing, accessories, footwear, and more. From high-end designer labels to affordable fashion finds, these apps provide a seamless shopping experience, allowing you to curate your wardrobe and express your unique sense of style with just a few taps",
  ...
  },
  {
    name: "Electronics",
    description:
      "Explore an extensive range of smartphones, laptops, cameras, audio equipment, and more. From top brands to the latest technological innovations, these apps provide a convenient platform to discover, compare, and purchase electronics that cater to your entertainment, communication, and productivity needs. Stay up-to-date with the latest tech trends and elevate your digital experience.",
  ...
  },
  {
    ...
    description:
      "Explore a variety of desktop computers with customizable configurations, robust processors, ample storage, and high-performance graphics. Whether for gaming, content creation, or professional work, find the perfect desktop to meet your computing needs and elevate your productivity.",
    image: "/images/desktops-category.jpeg",
  },
  {
  ...
  {
    name: "Computers/Smartphones/Apple",
    description:
  ...
  {
    name: "Computers/Smartphones/Samsung",
    description:
  ...
  {
    name: "Computers/Smartphones/OnePlus",
    description:
